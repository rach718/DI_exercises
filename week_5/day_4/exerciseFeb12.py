...
class ForceWielder:
    ...
    def fight(self, other):
        ...
        if fighter1 > fighter2:
            ...
            print(f'The winner is, {other.name}')
            return False
...
class Jedi(ForceWielder):
    def __init__(self, name):
        ...
        print(f'Jedi wisdom +10 {self.wisdom}')

    def train(self):
        self.wisdom = self.wisdom + random.randint(10,20)
        self.power = self.power + random.randint(5,15)
        print(f'Jedi wisdom and power increases {self.wisdom}, {self.power}')
...
class Sith(ForceWielder):
    def __init__(self, name):
        ...
        print(f'Sith power +10 {self.power}')

    def train(self):
        self.wisdom = self.wisdom + random.randint(5, 15)
        self.power = self.power + random.randint(10, 20)
        print(f'Sith wisdom and power increases {self.wisdom}, {self.power}')
