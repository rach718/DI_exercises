# class Book:
#     def __init__(self, title, author, text, sentences):
#         self.title = title
#         self.author = author
#         self.text = text
#         self.sentences = self.text.split('. ')
#
#     def __repr__(self): #needs to return a string
#         return f'Book: {self.title} by {self.author}'
#
#     def __add__(self, other):
#         return Book(title=self.title + ' & ' + other.title, author = self.author +" & " + other.author,
#                     text=self.text + '/n' + other.text)
#     def __len__(self):
...
#     zohar = Book(title="THe Zohar", author="Rabbi Shimon Bar Yohai", text="....")
...
#     print(zohar > Book)
#     print(zohar < Book)
#     #  checks if something is an instance of a specific class
